        ...
        <View style={estiloItem.container}> 
            ...
            <View style={estiloItem.formularioContainer}> 
                <View style={estiloItem.campoContainer}> 
                    <FontAwesome5 name="book" size={26} color="#192f6a" /> <TextInput 
                        style={estiloItem.campo} 
                        placeholder="Titulo" 
                        placeholderTextColor='#FFFFFF' 
                        onChangeText={
                            titulo => setItem({...item, titulo})
                        } 
                        value={item.titulo}
                /> 
                </View> 
                ...
                <View style={estiloItem.campoContainer}> 
                    ...
                    <TextInput 
                        style={estiloItem.campo} 
                        placeholder="Ano de publicacão" placeholderTextColor='#FFFFFF' 
                        keyboardType='numeric' 
                        maxLength={4} 
                        onChangeText={anoPublicacao => setItem({...item, anoPublicacao})}value={item.anoPublicacao ? item.anoPublicacao.toString():item.anoPublicacao}
                    /> 
                </View> 
                <View style={estiloItem.campoContainerDescricao}> 
                    <FontAwesome5 name="book-open" size={26} color="#192f6a" /> <ScrollView style={estiloItem.campoDescricaoScroll}>            <TextInput 
                            style= {estiloItem.campoDescricao} placeholder="Descricao" 
                            placeholderTextColor='#FFFFFF' 
                            multiline={true} 
                            numberOfLines={4} 
                            blurOnSubmit={false} 
